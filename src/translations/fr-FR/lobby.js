export default {
  activateRandom: 'Lancer la sélection aléatoire',
  whatIsThat: 'Lorsque la sélection aléatoire sera lancée par les administrateurs, les équipes aléatoires seront choisies et envoyées dans leurs map respectives.' +
