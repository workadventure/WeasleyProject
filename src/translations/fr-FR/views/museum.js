export default {
    keeperName : "Agent de Securité",
    bigRoomAccess: "Je ne vous avez pas reconnu ! Allez y, entrez, je vous en prie",
    bigRoomNoAccess: "Qui êtes vous ?! Vous ne pouvez pas rentrer si vous n'êtes pas invité, allez on dégage !",
    annuaryTitle : "livre super secret de la mort qui tue",
    annuaryContent: "Notes personnelles du 23 mai\n" +
        ...
        "Mamounette : 11/04/48\n" +
        "Papounou : 28/12/51\n" +
        "Cerbere (Bibou chat d’amour) : 16/06/16 ",
    beginText : "Après tant d'années, nos deux amis se sont retrouvés dans le but de trouver un artefact qui pourrait révolutionner l'humanité.\n\n" +
    ...
    beginDiscussion: "Enfin nous avons réussi à rentrer ! " +
        "Je te rappel le plan : \n" +
